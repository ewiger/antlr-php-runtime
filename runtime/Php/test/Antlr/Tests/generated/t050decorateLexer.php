...
class t050decorateLexer extends Lexer {
    const T_EOF=-1;
    ...
    function getGrammarFileName() { return "runtime/Php/test/Antlr/Tests/grammers/t050decorate.g"; }

    // $ANTLR start "IDENTIFIER"
    function mIDENTIFIER(){
        try {
            $_type = t050decorateLexer::T_IDENTIFIER;
            $_channel = t050decorateLexer::DEFAULT_TOKEN_CHANNEL;
