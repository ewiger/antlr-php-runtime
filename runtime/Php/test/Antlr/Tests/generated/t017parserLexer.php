<?php
// $ANTLR 3.2 Sep 23, 2009 12:02:23 runtime/Php/test/Antlr/Tests/grammers/t017parser.g 2010-09-10 19:39:24
...
function t017parserLexer_DFA4_static(){
...
class t017parserLexer_DFA4 extends DFA {

    private static $DFA = null;

    public function __construct($recognizer) {
        if (self::$DFA === null) {
            self::$DFA = t017parserLexer_DFA4_static();
        }
...
class t017parserLexer extends Lexer {
    const T_T__20=20;
    const T_INT=5;
    const T_ID=4;
    const T_EOF=-1;
    ...
    function __construct($input, $state=null){
        parent::__construct($input,$state);
            ...
            $this->dfa4 = new t017parserLexer_DFA4($this);
    }
    function getGrammarFileName() { return "runtime/Php/test/Antlr/Tests/grammers/t017parser.g"; }

    // $ANTLR start "T__7"
    function mT__7(){
        try {
            $_type = t017parserLexer::T_T__7;
            $_channel = t017parserLexer::DEFAULT_TOKEN_CHANNEL;
