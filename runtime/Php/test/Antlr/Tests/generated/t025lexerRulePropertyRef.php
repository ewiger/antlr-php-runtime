<?php
// $ANTLR 3.2 Sep 23, 2009 12:02:23 runtime/Php/test/Antlr/Tests/grammers/t025lexerRulePropertyRef.g 2010-09-10 19:39:31
...
class t025lexerRulePropertyRef extends Lexer {
    ...
    function getGrammarFileName() { return "runtime/Php/test/Antlr/Tests/grammers/t025lexerRulePropertyRef.g"; }

    // $ANTLR start "IDENTIFIER"
    function mIDENTIFIER(){
        try {
            $_type = t025lexerRulePropertyRef::T_IDENTIFIER;
            $_channel = t025lexerRulePropertyRef::DEFAULT_TOKEN_CHANNEL;
            // runtime/Php/test/Antlr/Tests/grammers/t025lexerRulePropertyRef.g
            // runtime/Php/test/Antlr/Tests/grammers/t025lexerRulePropertyRef.g
            {
            ...
            do {
              ...
              $this->properties[] = 
                  array($this->getText(), $_type, $this->state->tokenStartLine, $this->state->tokenStartCharPositionInLine, -1, $_channel, $this->state->tokenStartCharIndex, ($this->getCharIndex()-1));
    ...
    function mWS(){
        try {
            $_type = t025lexerRulePropertyRef::T_WS;
            $_channel = t025lexerRulePropertyRef::DEFAULT_TOKEN_CHANNEL;
            // runtime/Php/test/Antlr/Tests/grammers/t025lexerRulePropertyRef.g
            // runtime/Php/test/Antlr/Tests/grammers/t025lexerRulePropertyRef.g
            {
