...
class t035ruleLabelPropertyRefLexer extends Lexer {
    ...
    function getGrammarFileName() { return "runtime/Php/test/Antlr/Tests/grammers/t035ruleLabelPropertyRef.g"; }

    // $ANTLR start "A"
    function mA(){
        try {
            $_type = t035ruleLabelPropertyRefLexer::T_A;
            $_channel = t035ruleLabelPropertyRefLexer::DEFAULT_TOKEN_CHANNEL;
    ...
    function mWS(){
        try {
            $_type = t035ruleLabelPropertyRefLexer::T_WS;
            $_channel = t035ruleLabelPropertyRefLexer::DEFAULT_TOKEN_CHANNEL;
            // runtime/Php/test/Antlr/Tests/grammers/t035ruleLabelPropertyRef.g
            // runtime/Php/test/Antlr/Tests/grammers/t035ruleLabelPropertyRef.g
            {
