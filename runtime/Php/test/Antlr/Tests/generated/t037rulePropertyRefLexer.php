...
class t037rulePropertyRefLexer extends Lexer {
    ...
    function getGrammarFileName() { return "runtime/Php/test/Antlr/Tests/grammers/t037rulePropertyRef.g"; }

    // $ANTLR start "A"
    function mA(){
        try {
            $_type = t037rulePropertyRefLexer::T_A;
            $_channel = t037rulePropertyRefLexer::DEFAULT_TOKEN_CHANNEL;
    ...
    function mWS(){
        try {
            $_type = t037rulePropertyRefLexer::T_WS;
            $_channel = t037rulePropertyRefLexer::DEFAULT_TOKEN_CHANNEL;
            // runtime/Php/test/Antlr/Tests/grammers/t037rulePropertyRef.g
            // runtime/Php/test/Antlr/Tests/grammers/t037rulePropertyRef.g
            {
