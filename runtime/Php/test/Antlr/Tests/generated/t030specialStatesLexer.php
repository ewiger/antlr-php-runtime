...
class t030specialStatesLexer extends Lexer {
    ...
    function getGrammarFileName() { return "runtime/Php/test/Antlr/Tests/grammers/t030specialStates.g"; }

    // $ANTLR start "NAME"
    function mNAME(){
        try {
            $_type = t030specialStatesLexer::T_NAME;
            $_channel = t030specialStatesLexer::DEFAULT_TOKEN_CHANNEL;
    ...
    function mNUMBER(){
        try {
            $_type = t030specialStatesLexer::T_NUMBER;
            $_channel = t030specialStatesLexer::DEFAULT_TOKEN_CHANNEL;
            // runtime/Php/test/Antlr/Tests/grammers/t030specialStates.g
            // runtime/Php/test/Antlr/Tests/grammers/t030specialStates.g
            {
    ...
    function mWS(){
        try {
            $_type = t030specialStatesLexer::T_WS;
            $_channel = t030specialStatesLexer::DEFAULT_TOKEN_CHANNEL;
            // runtime/Php/test/Antlr/Tests/grammers/t030specialStates.g
            // runtime/Php/test/Antlr/Tests/grammers/t030specialStates.g
            {
