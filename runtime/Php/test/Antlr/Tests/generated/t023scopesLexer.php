...
class t023scopesLexer extends Lexer {
    ...
    function getGrammarFileName() { return "runtime/Php/test/Antlr/Tests/grammers/t023scopes.g"; }

    // $ANTLR start "ID"
    function mID(){
        try {
            $_type = t023scopesLexer::T_ID;
            $_channel = t023scopesLexer::DEFAULT_TOKEN_CHANNEL;
